          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-10">
              ...
              <p className="text-gray-700 mb-6">
                Sharebook was developed by a team of passionate readers and developers who wanted to 
                create a space where book lovers could connect. Our team comes from diverse backgrounds 
                but shares a common love for literature.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="w-24 h-24 rounded-full bg-gray-200 mx-auto mb-4"></div>
                  <h3 className="font-bold">Abirami R</h3>
